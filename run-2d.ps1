    ...
    foreach ($export in $exports) {
        ...
        if ($validation.touristEnabled) {
            ...
            $compositeArgs = @(
                ...
                '--ocean-coastal-color', (Get-ConfigValue $ocean 'coastalColor' (Get-ConfigValue $ocean 'color' '#C9DEE9')),
                '--ocean-deep-color', (Get-ConfigValue $ocean 'deepColor' (Get-ConfigValue $ocean 'color' '#C9DEE9')),
                '--ocean-coastal-distance', (Get-ConfigValue $ocean 'coastalDistanceM' 0),
                '--ocean-deep-distance', (Get-ConfigValue $ocean 'deepDistanceM' 1),
                '--coast-halo-color', (Get-ConfigValue $ocean 'coastHaloColor' '#D3E4EC'),
                '--coast-halo-width', (Get-ConfigValue $ocean 'coastHaloWidthPx' 4),
